...
## Dataset
- **Source:** Kaggle – Customer Shopping Behaviour Analysis  
- **Link:** https://www.kaggle.com/datasets/wardabilal/customer-shopping-behaviour-analysis/data  
- **Format:** CSV (e.g., `shopping_trends.csv`)
